    ...
    return (
        <div className="min-h-screen bg-[#1a1a1a] flex flex-col" style={{ position: 'relative' }}>
            ...
            <main className="relative mx-auto w-full max-w-7xl px-6 pt-20 pb-16 md:pt-28 flex-1 flex flex-col gap-8">
                <h1 className="text-center text-5xl md:text-6xl lg:text-7xl font-black leading-[0.95] text-white tracking-tight">FIS</h1>
                <p className="text-center text-white/80 max-w-3xl mx-auto">Case study content for FIS komt hier.</p>
            </main>
